...
const pages = [<a   href="/">Club</a>, "ACTIVITéS", <a  className="TarifPages" href="/TarifPages">Tarif</a>, <a  className="planning" href="/PlanningPages">PLANNING</a>];
  ...
  return (
    <AppBar  className="hey" position="static">
      <Container className="topBars" maxWidth="xl">
        ...
        <div >
         <a href="SignIn"> <h1 className="authentifications">Inscription </h1></a>
        </div>
      </Container>
    </AppBar>
  );
